      ...
      cardHTML = `
        <div class="card-notification">
          ...
          <div class="card-notification__infos">
            ...
            <button class="card-notification__infos--btn">
...
function openPopup() {
  let popupHTML = `
    ...
    `
  const cardNotificationData = document.getElementById('card-notification__test')
  cardNotificationData.insertAdjacentHTML("beforeend", popupHTML)
